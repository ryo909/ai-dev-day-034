import './style.css';
const PROFILE = {"day":"Day034","title":"Constraint Reveal Roulette 1","display_name_ja":"お題ルーレット","one_sentence":"すぐ遊べるお題を決めるためのツールです。","purpose_line_ja":"すぐ遊べるお題を決めるためのツールです。","use_case_line_ja":"短いお題で気分を変えたい時に使います。","how_it_works_line_ja":"お題を入れて回すと、今回のお題が出ます。","core_action":"spin","family":"constraint_game","mechanic":"spin_reveal","input_style":"preset_pool","output_style":"stacked_cards","audience_promise":"surprise","publish_hook":"重み付き評価で候補案の順位変化を比較できる計算ツール。（話題:GitHub Trending (A） を oddity 角度で見せる","engine":"constraint_game","interaction_archetype":"spin_reveal","page_archetype":"card_stack","output_shape":"card_stack","state_model":"spin_reveal_state","core_loop":"preset_pool -> spin_reveal -> stacked_cards","component_pack":"card_stack+stacked_cards","scaffold_id":"roulette_game","single_shot_text_generator":false};
